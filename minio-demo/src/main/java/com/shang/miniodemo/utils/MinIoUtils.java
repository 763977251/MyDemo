package com.shang.miniodemo.utils;
...
public class MinIoUtils {
     ...
     * 默认过期时间(分钟)
     */
    private final static Integer DEFAULT_EXPIRY = 10080;
     ...
     * @param prefix     对象名称前缀(文件夹 /xx/xx/xx.jpg 中的 /xx/xx/)
     * @return objectNames
     */
    ...
    public MinIoUploadResDTO upload(MultipartFile multipartFile, String bucketName, String directory) {
        ...
        try (InputStream inputStream = multipartFile.getInputStream()) {
            ...
            minFileName = directory + minFileName(multipartFile.getOriginalFilename());
            //上传文件到指定目录
