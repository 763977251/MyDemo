...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/zpark?useUnicode=true&characterEncoding=utf-8&useSSL=false&&serverTimezone=Asia/Shanghai",
                        "root", "111111")
...
//                            .moduleName("mybatis-plus-demo") // 设置父包模块名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("t_organization") // 设置需要生成的表名
